...
import com.hl.shoesshop.adapter.IndexGalleryAdapter;
import com.hl.shoesshop.entity.IndexGalleryItemData;
import com.hl.shoesshop.ui.base.BaseActivity;
import com.hl.shoesshop.utils.CommonTools;
import com.hl.shoesshop.widgets.jazzviewpager.JazzyViewPager;
import com.hl.shoesshop.widgets.jazzviewpager.JazzyViewPager.TransitionEffect;
import com.hl.shoesshop.widgets.jazzviewpager.OutlineContainer;
...
public class IndexActivity extends BaseActivity implements OnClickListener{
	...
	protected void initView() {
		...
		ImageLoader.getInstance().displayImage(
				"drawable://" + R.drawable.msha, mMiaoShaImage);
	...
	private void initData() {
		...
		mItemData.setId(1);
		mItemData.setImageUrl("drawable://" + R.drawable.zhanshi_01);
